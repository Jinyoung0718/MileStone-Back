...
import com.sjy.milestone.auth.dto.LoginDTO;
import com.sjy.milestone.auth.dto.MemberContextDTO;
import com.sjy.milestone.auth.dto.SignupDTO;
...
public class MemberService {
    ...
    public String login(LoginDTO loginDTO) {
        ...
        if (!member.getUserPassword().equals(loginDTO.getUserPassword())) { //  패스워드 암호화 Bcrypt
            throw new UnauthorizedException("이메일 또는 비밀번호가 잘못되었습니다.");
        }
